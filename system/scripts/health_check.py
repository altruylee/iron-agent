...
REQUIRED = [
    "AGENTS.md",
    "CLAUDE.md",
    ".cursor/rules/iron-agent.mdc",
    ".github/copilot-instructions.md",
    ".clinerules",
    ".roo/rules/iron-agent.md",
    "README.md",
    "SECURITY.md",
    "CONTRIBUTING.md",
    "CHANGELOG.md",
    ...
    "adapters/cursor/.cursor/rules/iron-agent.mdc",
    "adapters/vscode/.github/copilot-instructions.md",
    "adapters/cline/.clinerules",
    "adapters/roo/.roo/rules/iron-agent.md",
    ...
    "workspace/memory/episodes/finance/invoice/INDEX.md",
    "workspace/memory/episodes/finance/reconciliation/INDEX.md",
